<h2><a href="https://leetcode.com/problems/first-letter-to-appear-twice/editorial/?envType=problem-list-v2&envId=hash-table">2427. First Letter to Appear Twice</a></h2><h3>Easy</h3><hr><p>Given a string <code>s</code> consisting of lowercase English letters, return <em>the first letter to appear <strong>twice</strong></em>.</p>
